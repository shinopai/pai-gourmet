...
ActiveRecord::Schema[7.0].define(version: 2022_11_02_073828) do
  ...
  create_table "keeps", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "restaurant_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["restaurant_id"], name: "index_keeps_on_restaurant_id"
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "profile_image", default: "user_image.png"
  ...
  add_foreign_key "keeps", "restaurants"
